...
import com.norman.videoplayer.player.AndroidMediaPlayerFactory;
import com.norman.videoplayer.player.IjkPlayerFactory;
import com.norman.videoplayer.player.PlayerFactory;
import com.norman.videoplayer.render.RenderViewFactory;
import com.norman.videoplayer.render.SurfaceRenderViewFactory;
import com.norman.videoplayer.render.TextureRenderViewFactory;
...
public class VideoViewConfig {
    ...
    private VideoViewConfig(Builder builder) {
        ...
        if (builder.mPlayerFactory == null) {
            ...
            // TODO: 2019-11-15
//            mPlayerFactory = IjkPlayerFactory.create();
