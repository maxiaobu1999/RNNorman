...
import com.norman.videoplayer.controller.widget.MarqueeTextView;
...
public class TitleView extends FrameLayout implements IControlComponent {
    ...
    {
        setVisibility(GONE);
        LayoutInflater.from(getContext()).inflate(R.layout.video_player_layout_title_view, this, true);
