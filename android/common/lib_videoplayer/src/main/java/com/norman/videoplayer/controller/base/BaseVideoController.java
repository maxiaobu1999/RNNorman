...
import com.norman.videoplayer.utils.CutoutAdaptHelper;
import com.norman.videoplayer.utils.OrientationHelper;
...
public abstract class BaseVideoController extends FrameLayout
    ...
    protected ControlVideoView mMediaPlayerWrapper;
    /** 控制器是否处于显示状态 */
     ...
     */
    @CallSuper
    public void setMediaPlayer(ControlVideoView mediaPlayer) {
    ...
    public void setPlayState(int playState) {
        ...
        if (playState == Constants.STATE_IDLE) {
            reset();
        } else if (playState == Constants.STATE_PLAYBACK_COMPLETED) {
            mIsLocked = false;
            mShowing = false;
            stopProgress();
        } else if (playState == Constants.STATE_ERROR) {
            mShowing = false;
            stopProgress();
        }
    }
    ...
    public void setPlayerState(int playerState) {
        ...
        switch (playerState) {
            ...
            case Constants.PLAYER_FULL_SCREEN:
                ...
                mOrientationHelper.enable();
                break;
            case Constants.PLAYER_TINY_SCREEN:
                mOrientationHelper.disable();
                break;
        }
    }
...
//     * @return 是否成功进入全屏
//     */
//    protected boolean onStartFullScreen() {
//        Activity activity = PlayerUtils.scanForActivity(getContext());
//        if (activity == null || activity.isFinishing()) return false;
//        activity.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
//        mVideoView.onStartFullScreen();
//        return true;
//    }
//
//    /**
...
//     * @return 是否成功退出全屏
//     */
//    protected boolean onStopFullScreen() {
//        Activity activity = PlayerUtils.scanForActivity(getContext());
//        if (activity == null || activity.isFinishing()) return false;
//        mVideoView.onStopFullScreen();
//        activity.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
//        return true;
//    }
    ...
    public void onWindowFocusChanged(boolean hasWindowFocus) {
        ...
        if (mMediaPlayerWrapper.isPlaying() && (mEnableOrientation
//                || mVideoView.isFullScreen()
    ...
    protected void onOrientationPortrait(Activity activity) {
        ...
        mMediaPlayerWrapper.onStopFullScreen();
        activity.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
    }
    ...
    protected void onOrientationLandscape(Activity activity) {
        ...
        mMediaPlayerWrapper.onStartFullScreen();
        activity.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
    }
